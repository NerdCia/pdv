...
<nav class="my-3 py-2 px-4 bg-white rounded-pill shadow">
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
    ...
    <div class="text-center">
      <button type="button" class="btn btn-danger rounded-pill me-lg-2"><i class="bi bi-plus-lg me-1"></i>Nova
        Venda</button>
    </div>
  </div>
</nav>
...
<table class="bg-white w-100 shadow-lg align-middle rounded-5 mb-3">
  ...
  <tbody>
    @foreach ($sales as $sale)
      <tr class="border-bottom">
        <td class="text-center py-2 fs-5"><input class="form-check-input" type="checkbox" value="{{ $sale->id }}"></td>
